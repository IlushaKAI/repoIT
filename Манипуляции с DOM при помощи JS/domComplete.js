...
body.appendChild(div); // добавляет только элементы, а не строки + элементы в отличие от append
// Создать заголовок H1 "DOM (Document Object Model)"
const header = document.createElement('h1');
header.textContent = 'DOM (Document Object Model)'; // есть альтернатива Innertext - он выводит текст в консоль в соответствии с тем, как он отображается на странице(с учетом стилей)
